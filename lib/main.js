...
var checkpoint_array = new Array(),
    checkpointx_array = new Array(),
    checkpointy_array = new Array(),
    teleport_array = new Array(),
    teleportx_array = new Array(),
    teleporty_array = new Array(),
    speed = false,
    invisibility = false;
...
var PlayerEntity = me.ObjectEntity.extend({
    init: function(x, y, settings) {
        ...
        /*
        Get player at the last checkpoint
         */
        ...
        (according with the player sprite)
         */
        ...
        /*
         Play sound when player destroy BREAK TILES
         (only when invisible)
         */
        ...
        /*
        If player is invisible, he can destroy BREAK TILES
         */
    ...
    update: function() {
        ...
        if (!this.alive) {
            ...
            if (me.input.isKeyPressed("left") || me.input.isKeyPressed("right")) {
                if (speed == false) {
                    /*
                    Change animation sprite if player is invisible or not.
                     */
                    if (invisibility == true) {
            ...
            if ((this.vel.x == 0) && (speed == true)) {
                ...
                /*
                Set all the animations for jumping and stand
                 */
            ...
            if (a) {
                switch (a.type) {
                    case "speed":
                    /*
                    If user touch speed object,
                    player enter in speed mode and cant stop
                    until touch against a wall
                     */
                ...
                case "Invisible":
                    /*
                     If user touch invisible power,
                     player enter in invisible mode and can
                     break tiles
                     */
                    if (invisibility == false) {
                    ...
                    case "Visible":
                    /*
                    For normal situations or when touch
                    visible power object
                     */
                    if (invisibility == true) {
    ...
    megaJump: function() {
        ...
        /*
       When user touch the megajump object
        */
        me.audio.play("jump");
        if (speed == false) {
...
var Checkpoint = me.CollectableEntity.extend({
    ...
    onCollision: function(res, obj) {
        /*
        On collision, save the position of checkpoint
        in array.
         */
...
var Teleport = me.CollectableEntity.extend({
    ...
    onCollision: function(res, obj) {
        /*
        On colision, save teleport position in array.
         */
...
var CollectEntity = me.CollectableEntity.extend({
    ...
    onCollision: function(res, obj) {
        /*
        On collision with coin, time decreases 5 secounds
         */
...
/*
For all horizontal movable blocks
 */
...
/*
 For all vertical movable blocks
 */
...
var triggg = 0
/*
Spike will only be trigger when the user
colides with SpikeTrigger object.
 */
...
/*
Timer for the Spike after get trigger
 */
function trigg() {
    triggg++;
    if (triggg == 1) {
...
/*
Automatic Spikes ( goes up and down )
 */
